...
class MediaIndexerTest extends TestCase
{
    ...
    public function testIndexAll()
    {
        ...
        $this->eventDispatcher->dispatch(IndexerMediaEvents::INDEX_ALL_DOCUMENTS)->shouldBeCalled();
    ...
    public function testQueueAll()
    {
        ...
        $this->eventDispatcher->dispatch(IndexerMediaEvents::QUEUE_ALL_DOCUMENTS)->shouldBeCalled();
